...
<head>
    ...
    <script>
        if (window.location.href != "<%=basePath %>user/usermainpage") {
            window.location = "<%=basePath %>user/usermainpage";
        }
    </script>
</head>
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="<%=basePath %>user/userinfoupdatepage" class="small-box-footer">
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<%=basePath %>user/courseListpage" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="<%=basePath %>user/usercollectionservice" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
