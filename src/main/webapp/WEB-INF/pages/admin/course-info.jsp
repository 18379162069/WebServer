      ...
      <div class="mailbox row">
        <div class="row">
          ...
          <div class="col-md-10" style="background-color:#fff;padding-top: 3%">
            <input type="hidden" id="applId" value="${course.id}">
            <div><strong>课程名：</strong><span>${course.coursename}</span></div>
            <div><strong>课程价格：</strong><span>${course.courseprice}元</span></div>
            <div><strong>课程讲师：</strong><span>${course.courselecturer}</span></div>
            <div><strong>讲师email：</strong><span>${course.lectureremail}</span></div>
            <div><strong>课程介绍：</strong><br><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${course.coursedescription}</span></div>
            <div><strong>课程内容：</strong><br><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${course.coursecontent}</span></div>

            <div class="row">
              <div class="col-md-6" style="text-align: center;padding-bottom: 2%">
                <input type="button" onclick="agrAppl()" class="btn-primary" value="通过" style="width: 25%"/>
              </div>
              <div class="col-md-6"  style="text-align: center;padding-bottom: 2%">
                <input type="button" onclick="delAppl()" class="btn-danger" value="不通过" style="width: 25%"/>
              </div>
            </div>
          </div>
          <div class="col-md-1">
...
<script type="text/javascript">
  function agrAppl(){
    var id = $("#applId").val();
    window.location.href="<%=basePath%>admin/agrCourseCheck?id="+id;
  }
  function delAppl(){
    var id = $("#applId").val();
    window.location.href="<%=basePath%>admin/notAgrCourseCheck?id="+id;
  }
