...
<script>
    $(document).ready(function(){
        if(window.location!="<%=basePath%>lecturer/lecturercourseinfopage"){
            window.location.href="<%=basePath%>lecturer/lecturercourseinfopage";
        }
    })
</script>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                <td class="name">课程号</td>
                                                <td class="name">课程名称</td>
                                                <td class="name">课程讲师</td>
                                                <td class="name">课程模式</td>
                                                <td class="name">是否开班</td>
                                                <td class="time">操作</td>
                                            </tr>
                                            <c:if test="${passcourseList_LcturerPageList!=null}">
                                                <c:forEach begin="0" end="4" step="1"
                                                           items="${passcourseList_LcturerPageList}"
                                                           varStatus="status" var="obj">
                                                    <tr class="unread">
                                                        <td class="name">${obj.id}</td>
                                                        <td class="name">
                                                            <a href="<%=basePath%>course/courseinfopage?courseid=${obj.id}">
                                                                    ${obj.coursename}
                                                            </a></td>
                                                        <td class="name">${obj.courselecturer}</td>
                                                        <td class="name">${obj.coursemode}</td>
                                                        <c:if test="${obj.coursedocstate==null}">
                                                            <td class="name">否</td>
                                                        </c:if>
                                                        <c:if test="${obj.coursedocstate!=null}">
                                                            <td class="name">是</td>
                                                        ...
                                                        <td class="time">
                                                            ...
                                                            <a href="<%=basePath%>course/coursedocuploadpage?courseid=${obj.id}">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-mailbox">
                                            ...
                                            <c:if test="${unpasscourseList_LcturerPageList!=null}">
                                                <c:forEach begin="0" end="4" step="1"
                                                           items="${unpasscourseList_LcturerPageList}"
                                                           varStatus="status" var="obj">
                                                    <tr class="unread">
                                                        <td class="name">${obj.id}</td>
                                                        <td class="name"><a
                                                                href="<%=basePath%>course/courseinfopage?courseid=${obj.id}">
                                                                ${obj.coursename}
                                                        </a></td>
                                                        <td class="name">${obj.courselecturer}</td>
                                                        <td class="name">${obj.coursemode}</td>
                                                        ...
                                                        <td class="time"><a
                                                            ...
                                                            <a href="<%=basePath%>course/coursedelete?courseid=${obj.id}">
