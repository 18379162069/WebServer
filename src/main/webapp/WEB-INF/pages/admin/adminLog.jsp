        ...
        <div class="col-md-4 myLoginBox" style="margin-top: 8%">
            <div class="panel panel-default panelHead">
                ...
                <div class="panel-body">
                    <form action="<%=basePath %>admin/adminLog" method="post">
                        <div class="form-group">
                            <label for="inputAccount">管理员名/Account</label>
                            <input type="text" class="form-control" id="inputAccount" name="adminaccount" placeholder="Account">
                        </div>
                        <div class="form-group">
                            <label for="inputPassword">输入密码/Password</label>
                            <input type="password" class="form-control" id="inputPassword" name="adminpassword" placeholder="Password">
                        </div>
                        <div class="form-group">
