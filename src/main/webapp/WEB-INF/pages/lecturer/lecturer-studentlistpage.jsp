                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                <td class="name">学生姓名</td>
                                                <td class="name">学生手机号</td>
                                                <td class="name">学生邮箱</td>
                                                <td class="time">操作</td>
                                            </tr>
                                            <c:if test="${studentpay_YList!=null}">
                                                <c:forEach begin="0" end="4" step="1"
                                                           items="${studentpay_YList}"
                                                    ...
                                                    <tr class="unread">
                                                        ...
                                                        <td class="name">${obj.usertel}</td>
                                                        <td class="name">${obj.useremail}</td>
                                                        <td class="time">
                                                            <a href="<%=basePath%>course/courseinfopage?courseid=${obj.id}">
                                                                <button class="btn btn-primary btn-sm">查看学生信息</button>
                                                            </a>
                                                            <a href="<%=basePath%>course/courseinfopage?courseid=${obj.id}">
                                                                <button class="btn btn-primary btn-sm">删除学生信息</button>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
