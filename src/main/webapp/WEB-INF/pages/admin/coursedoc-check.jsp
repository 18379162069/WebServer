                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                ...
                                                <td class="name"><a href="">课程名</a></td>
                                                <td class="subject">讲师</td>
                                                <td class="time">讲师邮箱</td>
                                            </tr>
                                            <input type="hidden" id="pageNo" name="pageNo" value="${pageNo}"/>
                                            <c:if test="${courseDocList!=null}">
                                                <c:forEach items="${courseDocList}" varStatus="state" var="obj">
                                                    <tr class="unread">
                                                        <td class="small-col"><input type="checkbox"/></td>
                                                        <td class="name"><a href="<%=basePath%>admin/courseDocCheck?id=${obj.id}">${obj.coursename}</a></td>
                                                        <td class="subject">${obj.courselecturer}</td>
                                                        <td class="time">${obj.lectureremail}</td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                        </table>
