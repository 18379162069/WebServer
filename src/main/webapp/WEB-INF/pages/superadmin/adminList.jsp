...
<head>
    ...
    <script>
        $(document).ready(function(){
            if(window.location!="<%=basePath%>superadmin/adminlistpage"){
                window.location.href="<%=basePath%>superadmin/adminlistpage";
            }
        })
    </script>
</head>
                                        ...
                                        <table class="table table-mailbox">
                                            ...
                                            <c:if test="${adminList!=null}">
                                                <c:forEach
                                                    ...
                                                    <tr class="unread">
                                                        <td class="name">${status.count}</td>
                                                        <td class="name">
                                                                ${obj.adminaccount}
                                                        </td>
                                                        <td class="time">
                                                            <a href="<%=basePath%>superadmin/delteadmin?adminaccount=${obj.adminaccount}">
