      ...
      <div class="mailbox row">
        <div class="row">
          ...
          <div class="col-md-10" style="background-color:#fff;padding-top: 3%">
            <input type="hidden" id="applId" value="${news.id}">
            <div><strong>资讯名：</strong><span>${news.newsname}</span></div>
            <div><strong>资讯类型：</strong><span>${news.newstype}</span></div>
            <div><strong>公司名：</strong><span>${news.companyname}</span></div>
            <div><strong>公司联系电话：</strong><span>${news.companyusertel}</span></div>
            <div><strong>资讯简介：</strong><br><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${news.newsdescription}</span></div>
            <div><strong>资讯内容：</strong><br><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${news.newscontent}</span></div>
...
<script type="text/javascript">
  function agrAppl(){
    var id = $("#applId").val();
    window.location.href="<%=basePath%>admin/agrNewsContentCheck?id="+id;
  }
  function delAppl(){
    var id = $("#applId").val();
    window.location.href="<%=basePath%>admin/notAgrNewsContentCheck?id="+id;
  }
