        ...
        <section class="content">
            ...
            <div class="mailbox row">
                <div class="row">
                    ...
                    <div class="col-md-10" style="background-color:#fff;height:200px">
                        <div>
                            <c:if test="${picList!=null}">
                                <c:forEach items="${picList}" var="obj">
                                    <div class="col-md-12">
                                        <img src="<%=basePath%>admin/getDocPic/${obj}" alt="">
                                    </div>
                                </c:forEach>
                            </c:if>
                        </div>
                        ...
                        <div class="row" style="padding-bottom: 50px">
                            <div class="col-md-6" style="text-align: center;margin-top: 5%">
                                <a href="<%=basePath%>admin/agrCourseDocCheck?id=${id}"><input type="button" class="btn-primary agrDoc" value="通过" style="width: 15%"></a>
                            </div>
                            <div class="col-md-6" style="text-align: center;margin-top: 5%">
                                <a href="<%=basePath%>admin/notAgrCourseDocCheck?id=${id}"><input type="button" class="btn-danger noArgDoc" value="不通过" style="width: 15%"/></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
