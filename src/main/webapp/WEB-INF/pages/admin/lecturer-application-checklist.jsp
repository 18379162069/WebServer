                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                ...
                                                <td class="name">讲师姓名</td>
                                                <td class="subject">讲师所属单位</td>
                                                <td class="time">讲师邮箱</td>
                                            </tr>
                                            <c:if test="${lecturerList!=null}">
                                                <c:forEach items="${lecturerList}" varStatus="state" var="obj">
                                                    <tr class="unread">
                                                        <td class="small-col"><input type="hidden"/></td>
                                                        <td class="name"><a href="<%=basePath %>admin/getLecturerById?id=${obj.id}">${obj.lecturername}</a></td>
                                                        <td class="subject">${obj.lecturercompany}</td>
