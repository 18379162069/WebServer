...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <c:if test="${lectureraccount!=null}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" style="margin-left: 30%;margin-top: 15px">
                                    <a class="btn btn-primary"
                                       href="<%=basePath%>course/courseinfodatepage?courseid=${course.id}">修改</a>
                                </div>
                                </c:if>
                                <c:if test="${userAccount!=null}">
                                    <div class="col-md-4" style="margin-left: 30%;margin-top: 15px">
                                        <a class="btn btn-primary"
                                           href="<%=basePath%>course/courseinfodatepage?courseid=${course.id}">退课</a>
                                    </div>
                                </c:if>
                            </div>
                        </div>
