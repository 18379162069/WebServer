                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                ...
                                                <td class="name"><a href="">企业名</a></td>
                                                <td class="subject">申请人邮箱</td>
                                                <td class="time">申请时间</td>
                                            </tr>
                                            <c:if test="${companyUserApplList!=null}">
                                                <c:forEach items="${companyUserApplList}" varStatus="state" var="obj">
                                                    <tr class="unread info_list">
                                                        <td class="small-col"><input type="hidden"/></td>
                                                        <td class="name"><a href="<%=basePath%>admin/getCReasonById?id=${obj.id}">${obj.companyusername}</a></td>
                                                        <td class="subject">${obj.companyuseremail}</td>
                                                        <td class="time">${obj.applicationtime}</td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                        </table>
