...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            <c:if test="${cooperation!=null}">
                <c:forEach   varStatus="status" begin="0" end="4" >
                <div class="row">
                    <div class="col-md-4">
                        <label>合作伙伴${status.count}</label>
                    </div>
                    <div class="col-md-4">
                        <form action="<%=basePath%>superadmin/cooperation_update" method="post">
                            <input type="text" name="cooperationname" value="${cooperation.get(status.count-1)}">
                            <input type="hidden" name="cooperationnum" value="${status.count}">
