                                            ...
                                            <c:if test="${newsList!=null}">
                                                <c:forEach items="${newsList}" varStatus="state" var="obj">
                                                    <tr class="unread">
                                                        ...
                                                        <td class="time"><input type="button" class="btn-xs btn-primary" value="增加" onclick="window.location.href='<%=basePath%> admin/goToUeditor?id=${obj.id}'"></td>
                                                        <td class="time"><a href="<%=basePath%>admin/delNews?id=${obj.id}"><span style="margin-top: 6% !important; margin-right: 7% !important; color: rgb(51,122,183);" class="glyphicon glyphicon-remove"></span></a></td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                        </table>
                ...
                <div class="col-md-4 myLoginBox" style="margin-top: 8%">
                    <div class="panel panel-default panelHead">
                        ...
                        <div class="panel-body">
                            <form onsubmit="return checkForm()" action="<%=basePath %>admin/addNews" method="post" enctype="multipart/form-data">
