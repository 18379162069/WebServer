...
<head>
    ...
    <script>
        if (window.location.href != "<%=basePath %>admin/adminIndex") {
            window.location = "<%=basePath %>admin/adminIndex";
        }
    </script>
</head>
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="<%=basePath %>admin/courseDocCheckList" class="small-box-footer">
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<%=basePath %>admin/courseCheckList" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="<%=basePath %>admin/serviceCheckList" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-purple">
                        ...
                        <a href="<%=basePath %>admin/companyUserApplCheckList" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3>
                                ${lecturerCheckCount}<sup style="font-size: 20px"></sup>
                            </h3>
                        ...
                        <a href="<%=basePath %>admin/lecturerApplCheckList" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-red">
                        ...
                        <a href="<%=basePath %>admin/newsCheckList" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
