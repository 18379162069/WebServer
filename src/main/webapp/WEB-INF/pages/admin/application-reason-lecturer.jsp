            ...
            <div class="mailbox row">
                <div class="row">
                    ...
                    <div class="col-md-10" style="background-color:#fff;padding-top: 3%">
                        <input type="hidden" id="applId" value="${lecturer.id}">
                        <div><strong>讲师姓名：</strong><span>${lecturer.lecturername}</span></div>
                        <div><strong>讲师所属单位：</strong><span>${lecturer.lecturercompany}</span></div>
                        <div><strong>讲师email：</strong><span>${lecturer.lectureremail}</span></div>
                        <div><strong>讲师介绍：</strong><br><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${lecturer.lecturerdescription}</span></div>
                        <div><strong>申请理由：</strong><br><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${lecturer.lecturerapplreason}</span></div>
                        <div class="row">
...
<script type="text/javascript">
    function agrAppl(){
        var id = $("#applId").val();
        window.location.href="<%=basePath%>admin/agrLApplById?id="+id;
    }
    function delAppl(){
        var id = $("#applId").val();
        window.location.href="<%=basePath%>admin/delLApplById?id="+id;
    }
    $(function () {
