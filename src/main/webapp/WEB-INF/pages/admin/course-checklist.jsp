                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                ...
                                                <td class="name">课程名</td>
                                                <td class="subject">讲师</td>
                                                <td class="time">讲师邮箱</td>
                                            </tr>
                                            <input type="hidden" id="pageNo" name="pageNo" value="${pageNo}"/>
                                            <c:if test="${courseList!=null}">
                                                <c:forEach items="${courseList}" varStatus="state" var="obj">
                                                    <tr class="unread">
                                                        <input type="hidden" value="${obj.id}"/>
                                                        <td class="small-col"><input type="hidden"></td>
                                                        <td class="name"><a href="<%=basePath%>admin/courseCheckInfo?id=${obj.id}">${obj.coursename}</a></td>
