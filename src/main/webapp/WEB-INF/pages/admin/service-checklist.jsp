...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            var nowLoc = "<%=basePath%>admin/serviceCheckList";
            if (loc.indexOf(nowLoc)<0) {
                window.location.href = "<%=basePath%>admin/serviceCheckList";
            }
        })
    </script>
</head>
                    ...
                    <div class="box box-solid">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-mailbox">
                                            <tr class="unread">
                                                ...
                                                <td class="name"><a href="">业务名</a></td>
                                                <td class="subject">业务负责公司名</td>
                                                <td class="time">状态</td>
                                                <td class="time">公司负责人电话</td>
                                            </tr>
                                            ...
                                            <c:if test="${serviceList!=null}">
                                                <c:forEach items="${serviceList}" varStatus="state" var="obj">
                                                    <tr class="unread">
                                                        <td class="small-col"><input type="hidden"/></td>
                                                        <td class="name"><a href="<%=basePath%>admin/serviceCheckInfo?id=${obj.id}">${obj.servicename}</a>
                                                        </td>
                                                        <td class="subject">${obj.servicemanage}</td>
                                                        <c:if test="${obj.servicecheck==null}">
                                                            <td class="time" style="color: green">增</td>
                                                        </c:if>
                                                        <c:if test="${obj.servicecheck=='-1'}">
                                                            <td class="time" style="color: red">删</td>
                                                        </c:if>
                                                        <td class="time">${obj.servicemanagetel}</td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                        </table>
                        ...
                        <div class="box-footer clearfix">
                            <div class="pull-right">
                                ...
                                <button class="btn btn-xs btn-primary" onclick="goToPrevious()"><i
                                        class="fa fa-caret-left"></i></button>
                                <button class="btn btn-xs btn-primary" onclick="goToNext()"><i
...
<script type="text/javascript">
    ...
    function goToNext() {
        window.location.href = "<%=basePath%>admin/serviceCheckList?pageNo=" + nextPageNo;
    }

    function goToPrevious() {
        window.location.href = "<%=basePath%>admin/serviceCheckList?pageNo=" + prePageNo;
    }
...
<!-- Bootstrap --><script src="<%=basePath %>res/js/jquery-2.1.1.min.js"></script>
