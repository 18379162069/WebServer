...
<head>
    ...
    <script>
        if (window.location.href != "<%=basePath %>lecturer/lecturerBGPage") {
            window.location = "<%=basePath %>lecturer/lecturerBGPage";
        }
    </script>
</head>
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="<%=basePath %>lecturer/lecturerInfoPage" class="small-box-footer">
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<%=basePath %>lecturer/lecturercourseinfopage" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="<%=basePath %>lecturer/coursestudentpage" class="small-box-footer">
                            查看具体 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
